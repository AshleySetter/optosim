...
if 'READTHEDOCS' not in os.environ:
    from solveRK_lia import solve as solve_cython
...
class sde_solver():
    ...
    def __init__(self, Omega0, Gamma0, deltaGamma, mass,
                 ...
                 liaAmplitude, liaPhaseDelay, liadTau = lia,                 
        ...
        self.alpha = alpha
        self.beta = beta
        self.liaAmplitude = liaAmplitude
        self.liaPhaseDelay = liaPhaseDelay
...
#        return p
    ...
    def solve(self, NumTimeSteps=None, startIndex=0):
        ...
        self.q, self.v = solve_cython(self.q,
                                      ...
                                      float(self.alpha),
                                      float(self.beta),
                                      float(self.liaAmplitude),
                                      float(self.liaPhaseDelay),
                                      float(self.liadTau),
